...
const apiUrl = "https://infinite-gpt.p.rapidapi.com/infinite-gpt"; // Replace with your API URL
const apiKey = "1dc16be9ccmsh6df3721a5f10d2ap1f1670jsn2d50fb26ca53"; // Replace with your API key
  ...
  try {
    const response = await fetch(apiUrl, {
      ...
      headers: {
        ...
        "x-rapidapi-host": "infinite-gpt.p.rapidapi.com", // Replace with your API host
        "Content-Type": "application/json"
      },
      body: JSON.stringify({
        query: userMessage,
    ...
    const botMessage = data.msg || "Sorry, I could not understand that.";
    return botMessage;
  } catch (error) {
    console.error("Error fetching the bot message:", error);
